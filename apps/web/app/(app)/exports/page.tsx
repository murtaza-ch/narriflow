...
export default async function ExportsPage({
  ...
  const aspectRatio = aspectRatios.includes(params.ratio as ClipAspectRatio) ? params.ratio as ClipAspectRatio : undefined;
          ...
          {exports.map((item) => (
            <Flex key={item.id} align={{ base: "flex-start", md: "center" }} direction={{ base: "column", md: "row" }} gap="4" py="4" borderBottomWidth="1px" borderColor="border.subtle">
              ...
              <Flex align="center" gap="4">
                ...
                <Flex gap="1">
                  {item.variants.filter((variant) => variant.status === "completed" && variant.storageKey).map((variant) => (
