...
const paramsInput = (...params: string[]) => ({
	schema: z
		.object(Object.fromEntries(params.map((name) => [name, uuidInput])))
		.strict(),
	params,
});
const idempotentBodyInput = (schema: ZodType, params: readonly string[]) => ({
	schema: z
		.object({
			...Object.fromEntries(params.map((name) => [name, uuidInput])),
			body: schema,
...
const campaignMutationInput = (schema: ZodType, params: readonly string[]) => {
...
export const browserSessionHonoSurfaces: readonly HonoSurface[] = [
	...
	{
		method: "POST",
		path: "/projects/:id/export-bundles",
		capability: "content.download",
		projectParam: "id",
		rateLimit: actorRate("export-bundle", 10, 3_600),
		input: idempotentBodyInput(createExportBundleSchema, ["id"]),
	},
	{
		method: "POST",
		path: "/projects/:id/export-bundles/preview",
		capability: "content.download",
		projectParam: "id",
		rateLimit: actorRate("export-bundle-preview", 60),
		input: bodyInput(createExportBundleSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/projects/:id/export-bundles",
	...
	{
		method: "GET",
		path: "/projects/:id/campaign-operations",
		capability: "content.view",
		projectParam: "id",
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/schedule/preview",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("publishing-preview", 60),
		input: bodyInput(publishingPreviewSchema, ["id"]),
	},
	{
		method: "GET",
	...
	{
		method: "POST",
		path: "/projects/:id/social-posts/:postId/refresh-inbox",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("refresh-inbox", 20),
		input: paramsInput("id", "postId"),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/schedule",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("campaign-schedule", 20, 3_600),
		input: bodyInput(bulkSocialScheduleSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/projects/:id/exports/current",
		capability: "content.view",
		projectParam: "id",
	...
	{
		method: "POST",
		path: "/projects/:id/assisted-copy/generations",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("assisted-copy", 30),
		input: bodyInput(generateAssistedCopySchema, ["id"]),
	},
	{
		method: "POST",
		path: "/projects/:id/thumbnail-frames",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("thumbnail-frame", 30),
		input: bodyInput(requestThumbnailFrameSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/projects/:id/thumbnail-frames/:operationId",
		capability: "content.view",
		projectParam: "id",
		input: paramsInput("id", "operationId"),
	},
	{
		method: "POST",
		path: "/projects/:id/thumbnail-frames/:operationId/retry",
		capability: "publishing.manage",
		projectParam: "id",
		rateLimit: actorRate("thumbnail-frame-retry", 20),
		input: paramsInput("id", "operationId"),
	},
	{
		method: "GET",
		path: "/projects/:id/campaign-operations/editor-action-catalog",
		capability: "content.view",
		projectParam: "id",
		input: paramsInput("id"),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/preview-editor-action",
		capability: "content.view",
		projectParam: "id",
		rateLimit: actorRate("preview-campaign-editor-action", 60),
		input: bodyInput(previewCampaignEditorActionSchema, ["id"]),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/apply-brand-profile",
		capability: "content.edit",
		projectParam: "id",
		rateLimit: actorRate("apply-brand-profile-selected", 20, 3_600),
		input: campaignMutationInput(applyProjectBrandProfileSelectedSchema, [
			"id",
		]),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/apply-style",
		capability: "content.edit",
		projectParam: "id",
		rateLimit: actorRate("apply-style-selected", 20, 3_600),
		input: campaignMutationInput(applyStyleSelectedSchema, ["id"]),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/apply-motion",
		capability: "content.edit",
		projectParam: "id",
		rateLimit: actorRate("apply-motion-selected", 20, 3_600),
		input: campaignMutationInput(applyMotionSelectedSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/projects/:id/export-bundles/:bundleId",
		capability: "content.view",
		projectParam: "id",
		input: paramsInput("id", "bundleId"),
	},
	{
		method: "GET",
		path: "/projects/:id/export-bundles/:bundleId/download",
		capability: "content.download",
		projectParam: "id",
		input: paramsInput("id", "bundleId"),
	},
	{
		method: "POST",
		path: "/projects/:id/export-bundles/:bundleId/retry",
		capability: "content.download",
		projectParam: "id",
		rateLimit: actorRate("export-bundle-retry", 10, 3_600),
		input: idempotentParamsInput("id", "bundleId"),
	},
	{
		method: "POST",
		path: "/projects/:id/campaign-operations/:operationId/retry-export-bundle",
		capability: "content.download",
		projectParam: "id",
		rateLimit: actorRate("export-operation-retry", 10, 3_600),
		input: idempotentParamsInput("id", "operationId"),
	},
	{
		method: "POST",
		path: "/projects/:id/brand-profiles/:profileId/scene-templates/:templateId/apply",
		capability: "content.edit",
		projectParam: "id",
		rateLimit: actorRate("apply-scene-template", 20, 3_600),
		input: campaignMutationInput(applySceneTemplateSchema, [
			"id",
			"profileId",
			"templateId",
		]),
	...
	{
		method: "POST",
		path: "/projects/:id/review-rounds",
		capability: "review.manage",
		projectParam: "id",
		rateLimit: actorRate("review-round", 20, 3_600),
		input: bodyInput(createReviewRoundSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/projects/:id/review-rounds",
	...
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/invite",
		capability: "review.manage",
		projectParam: "id",
		rateLimit: actorRate("review-invite", 20, 3_600),
		input: bodyInput(inviteReviewersSchema, ["id", "roundId"]),
	},
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/comments",
		capability: "review.manage",
		projectParam: "id",
		rateLimit: actorRate("review-comment-internal", 60),
		input: bodyInput(internalReviewCommentSchema, ["id", "roundId"]),
	},
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/comments/:commentId/resolve",
		capability: "review.manage",
		projectParam: "id",
		input: paramsInput("id", "roundId", "commentId"),
	},
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/comments/:commentId/reopen",
		capability: "review.manage",
		projectParam: "id",
		input: paramsInput("id", "roundId", "commentId"),
	},
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/notifications/retry",
		capability: "review.manage",
		projectParam: "id",
		rateLimit: actorRate("review-notification-retry", 20, 3_600),
		input: bodyInput(retryReviewNotificationSchema, ["id", "roundId"]),
	},
	{
		method: "POST",
		path: "/projects/:id/review-rounds/:roundId/revoke",
		capability: "review.manage",
		projectParam: "id",
		input: paramsInput("id", "roundId"),
	},
	project(
		"GET",
	...
	{
		method: "GET",
		path: "/social/oauth/facebook-selection/:token",
		capability: "social.manage",
	},
	{
		method: "POST",
		path: "/social/oauth/facebook-selection/:token",
		capability: "social.manage",
		rateLimit: actorRate("facebook-page-selection", 10, 900),
	},
	{
		method: "DELETE",
	...
	},
	{
		...
		path: "/brand-profiles",
		capability: "brand.manage",
		input: bodyInput(brandProfileCreateSchema),
	},
	{
		method: "PATCH",
		path: "/brand-profiles/:id",
		capability: "brand.manage",
		input: bodyInput(brandProfileUpdateSchema, ["id"]),
	},
	{
		method: "PUT",
		path: "/brand-profiles/:id/membership",
		capability: "brand.manage",
		input: bodyInput(brandProfileMembershipSchema, ["id"]),
	},
	{
		method: "POST",
		path: "/brand-profiles/:id/set-default",
		capability: "brand.manage",
		input: paramsInput("id"),
	},
	{
		...
		path: "/brand-profiles/:id",
		capability: "brand.manage",
		input: bodyInput(brandProfileSoftDeleteSchema, ["id"]),
	},
	{
		method: "GET",
		path: "/brand-profiles/:id/scene-templates",
		capability: "content.view",
		input: paramsInput("id"),
	},
	{
		...
		path: "/brand-profiles/:id/scene-templates",
		capability: "brand.manage",
		input: bodyInput(sceneTemplateCreateSchema, ["id"]),
	},
	{
		method: "PATCH",
		path: "/brand-profiles/:id/scene-templates/:templateId",
		capability: "brand.manage",
		input: bodyInput(sceneTemplateUpdateSchema, ["id", "templateId"]),
	},
	{
		method: "DELETE",
		path: "/brand-profiles/:id/scene-templates/:templateId",
		capability: "brand.manage",
		input: bodyInput(sceneTemplateDeleteSchema, ["id", "templateId"]),
	},
	...
	},
	{
		...
		path: "/visual-assets",
		capability: "brand.manage",
		input: bodyInput(visualAssetFinalizeSchema),
	},
	{
		method: "DELETE",
		path: "/visual-assets/:id",
		capability: "brand.manage",
		input: optionalBodyInput(reusableAssetSoftDeleteSchema, ["id"]),
	},
	{
		method: "GET",
	...
	{
		method: "GET",
		path: "/projects/:projectId/generated-media/jobs/:id",
		capability: "content.view",
		projectParam: "projectId",
		input: paramsInput("projectId", "id"),
	},
	{
		method: "POST",
		path: "/projects/:projectId/generated-media/jobs/:id/cancel",
		capability: "content.edit",
		projectParam: "projectId",
		input: paramsInput("projectId", "id"),
	},
	{
		method: "DELETE",
		path: "/projects/:projectId/generated-media/jobs/:id/result",
		capability: "content.edit",
		projectParam: "projectId",
		input: paramsInput("projectId", "id"),
	},
	...
	},
	{
		...
		path: "/brand-fonts",
		capability: "brand.manage",
		input: bodyInput(brandFontFinalizeSchema),
	},
	{
		method: "DELETE",
		path: "/brand-fonts/:id",
...
export const browserSessionServerActions: readonly ServerActionSurface[] = [
	...
	action(
		"app/(app)/projects/actions.ts",
		"renderClipsFormAction",
		"project",
		"processing.consume",
	),
	action(
		"app/(app)/projects/actions.ts",
		"retryIngestFormAction",
		"project",
		"processing.consume",
	),
	action(
	...
	action(
		"app/(app)/brand-kit/style-actions.ts",
	...
	action(
		"app/(app)/upload/actions.ts",
		"commitLinkImportAction",
		"workspace",
		"processing.consume",
	),
	action(
	...
	action(
		"app/(app)/projects/[projectId]/clips/[clipId]/studio/page.tsx",
		"fetchPreviewStatus",
		"project",
		"content.edit",
	),
...
export const browserSessionPages: readonly PageSurface[] = [
	...
	page("app/(app)/brand-kit/styles/[id]/page.tsx"),
	page("app/(app)/settings/members/page.tsx"),
	page("app/(app)/settings/profile/page.tsx"),
	page("app/(app)/settings/social-accounts/page.tsx"),
...
export const browserSessionInheritedPageModules = [
	...
	"app/(app)/brand-kit/styles/new/page.tsx",
...
export const independentTrustModules = [
	...
	{ module: "app/share/[token]/page.tsx", trustModel: "public_share_token" },
	{
		...
		trustModel: "signed_review_guest_session",
	},
] as const;
