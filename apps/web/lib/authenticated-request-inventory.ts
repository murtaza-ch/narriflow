...
export const browserSessionHonoSurfaces: readonly HonoSurface[] = [
  ...
  {
    method: "GET",
    path: "/projects/:id/clips/:clipId/generated-media/assets/:assetId/playback",
    capability: "content.view",
    projectParam: "id",
    input: {
      schema: generatedMediaBrollPlaybackSchema
        .omit({ projectId: true })
        .extend({ id: uuidInput })
        .strict(),
      params: ["id", "clipId", "assetId"],
      query: ["fingerprint", "mediaKind"],
    },
  },
  {
    method: "GET",
    path: "/projects/:id/generated-media/jobs",
    capability: "content.view",
    projectParam: "id",
    input: {
      schema: z.object({
  ...
  },
  {
    ...
    capability: "processing.consume",
    projectParam: "id",
    rateLimit: actorRate("generated-media-submit", 20, 3_600),
    input: bodyInput(generatedMediaStudioSubmitSchema, ["id"]),
  },
  {
    method: "GET",
    path: "/projects/:id/generated-media/jobs/:jobId",
    capability: "content.view",
    projectParam: "id",
    input: paramsInput("id", "jobId"),
  },
  {
    method: "GET",
    path: "/projects/:id/generated-media/jobs/:jobId/download",
    capability: "content.download",
    projectParam: "id",
    input: paramsInput("id", "jobId"),
  },
  {
    method: "POST",
    path: "/projects/:id/generated-media/jobs/:jobId/cancel",
    capability: "content.edit",
    projectParam: "id",
    input: paramsInput("id", "jobId"),
  },
  {
    method: "POST",
    path: "/projects/:id/generated-media/jobs/:jobId/insertions",
    capability: "content.edit",
    projectParam: "id",
    input: bodyInput(generatedMediaEditorInsertionSchema, ["id", "jobId"]),
  },
  {
    method: "POST",
    path: "/projects/:id/generated-media/jobs/:jobId/brand-profile",
  ...
  {
    method: "DELETE",
    path: "/projects/:id/generated-media/jobs/:jobId/asset",
    capability: "brand.manage",
    projectParam: "id",
    input: paramsInput("id", "jobId"),
  },
  ...
  { method: "POST", path: "/projects/:id/assisted-copy", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("assisted-copy", 30), input: bodyInput(generateAssistedCopySchema, ["id"]) },
  { method: "GET", path: "/projects/:id/assisted-copy", capability: "content.view", projectParam: "id", input: { schema: listAssistedCopySchema.extend({ id: uuidInput }), params: ["id"], query: ["platform"] } },
  { method: "GET", path: "/projects/:id/assisted-copy/:draftId", capability: "content.view", projectParam: "id", input: paramsInput("id", "draftId") },
  { method: "POST", path: "/projects/:id/assisted-copy/:draftId/confirm", capability: "publishing.manage", projectParam: "id", input: bodyInput(confirmAssistedCopySchema, ["id", "draftId"]) },
  { method: "POST", path: "/projects/:id/thumbnail-extractions", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("thumbnail-extraction", 30), input: bodyInput(requestThumbnailExtractionSchema, ["id"]) },
  { method: "GET", path: "/projects/:id/thumbnail-extractions", capability: "content.view", projectParam: "id", input: { schema: listThumbnailExtractionsSchema.extend({ id: uuidInput }), params: ["id"], query: ["platform", "exportVariantIds"] } },
  { method: "GET", path: "/projects/:id/thumbnail-extractions/:jobId", capability: "content.view", projectParam: "id", input: paramsInput("id", "jobId") },
  { method: "POST", path: "/projects/:id/thumbnail-extractions/:jobId/retry", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("thumbnail-extraction-retry", 10), input: paramsInput("id", "jobId") },
  { method: "POST", path: "/projects/:id/bulk-schedules", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("bulk-schedule", 10, 3_600), input: bodyInput(bulkScheduleSchema, ["id"]) },
  ...
  { method: "POST", path: "/projects/:id/review-rounds/:roundId/comments", capability: "review.manage", projectParam: "id", rateLimit: actorRate("review-comment", 60, 900), input: bodyInput(internalReviewCommentSchema, ["id", "roundId"]) },
  ...
  { method: "POST", path: "/projects/:id/review-rounds/:roundId/resend", capability: "review.manage", projectParam: "id", rateLimit: actorRate("review-resend", 20, 3_600), input: bodyInput(reviewNotificationRetrySchema, ["id", "roundId"]) },
  { method: "POST", path: "/projects/:id/review-rounds/:roundId/notifications/:notificationId/retry", capability: "review.manage", projectParam: "id", rateLimit: actorRate("review-notification-retry", 30, 3_600), input: bodyInput(reviewNotificationRetrySchema, ["id", "roundId", "notificationId"]) },
