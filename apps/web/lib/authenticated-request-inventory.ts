...
export const browserSessionHonoSurfaces: readonly HonoSurface[] = [
  ...
  { method: "POST", path: "/projects/:id/campaign-operations/schedule", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("campaign-schedule", 20, 3_600), input: bodyInput(bulkSocialScheduleSchema, ["id"]) },
	{ method: "GET", path: "/projects/:id/exports/current", capability: "content.view", projectParam: "id", input: paramsInput("id") },
  { method: "POST", path: "/projects/:id/assisted-copy/generations", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("assisted-copy", 30), input: bodyInput(generateAssistedCopySchema, ["id"]) },
  { method: "POST", path: "/projects/:id/assisted-copy/variants/:variantId/confirm", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("assisted-copy-confirm", 120), input: bodyInput(confirmAssistedCopySchema, ["id", "variantId"]) },
  { method: "POST", path: "/projects/:id/thumbnail-frames", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("thumbnail-frame", 30), input: bodyInput(requestThumbnailFrameSchema, ["id"]) },
  { method: "GET", path: "/projects/:id/thumbnail-frames/:operationId", capability: "content.view", projectParam: "id", input: paramsInput("id", "operationId") },
  { method: "POST", path: "/projects/:id/thumbnail-frames/:operationId/retry", capability: "publishing.manage", projectParam: "id", rateLimit: actorRate("thumbnail-frame-retry", 20), input: paramsInput("id", "operationId") },
  ...
  { method: "POST", path: "/projects/:id/review-rounds/:roundId/invite", capability: "review.manage", projectParam: "id", rateLimit: actorRate("review-invite", 20, 3_600), input: bodyInput(inviteReviewersSchema, ["id", "roundId"]) },
  ...
  { method: "POST", path: "/projects/:id/review-rounds/:roundId/notifications/retry", capability: "review.manage", projectParam: "id", rateLimit: actorRate("review-notification-retry", 20, 3_600), input: bodyInput(retryReviewNotificationSchema, ["id", "roundId"]) },
...
export const browserSessionServerActions: readonly ServerActionSurface[] = [
  ...
  action("app/(app)/brand-kit/style-actions.ts", "createBrandTemplateAction", "workspace", "brand.manage"),
  action("app/(app)/brand-kit/style-actions.ts", "updateBrandTemplateAction", "workspace", "brand.manage"),
  action("app/(app)/brand-kit/style-actions.ts", "deleteBrandTemplateAction", "workspace", "brand.manage"),
  action("app/(app)/brand-kit/style-actions.ts", "setDefaultBrandTemplateAction", "workspace", "workspace.manage"),
  action("app/(app)/brand-kit/style-actions.ts", "duplicateBrandTemplateAction", "workspace", "brand.manage"),
...
export const independentTrustModules = [
  ...
  { module: "app/api/review/[token]/[[...review]]/route.ts", trustModel: "signed_review_guest_session" },
] as const;
