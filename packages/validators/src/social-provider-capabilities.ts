export const SOCIAL_PROVIDER_CAPABILITIES = {
  youtube_shorts: {
    ...
    durationSec: { min: 1, max: 43_200 }, textLimit: 5_000, thumbnailTypes: ["provider_default", "custom_image"], titleField: true, firstCommentField: false, providerPolling: true, scheduling: true,
  },
  instagram_reels: {
    ...
    durationSec: { min: 3, max: 900 }, textLimit: 2_200, thumbnailTypes: ["video_frame"], titleField: false, firstCommentField: false, providerPolling: true, scheduling: true,
  },
  facebook_reels: {
    ...
    durationSec: { min: 4, max: 60 }, textLimit: 2_200, thumbnailTypes: ["video_frame"], titleField: true, firstCommentField: false, providerPolling: true, scheduling: true,
  },
  tiktok: {
    ...
    durationSec: { min: 3, max: 600 }, textLimit: 2_200, thumbnailTypes: ["video_frame"], titleField: true, firstCommentField: false, providerPolling: true, scheduling: true,
  },
  linkedin: {
    version: "202608", apiVersion: "202608", requiredScopes: ["openid", "profile", "w_member_social"],
    connectionEnabled: true, publishingEnabledByDefault: true, aspectRatios: ["9:16", "1:1", "16:9", "4:5"],
    durationSec: { min: 1, max: 600 }, textLimit: 3_000, thumbnailTypes: ["provider_default"], titleField: false, firstCommentField: false, providerPolling: true, scheduling: true,
  },
  x: {
    version: "x-v2", apiVersion: "v2", requiredScopes: ["tweet.read", "tweet.write", "users.read", "offline.access", "media.write"],
    connectionEnabled: true, publishingEnabledByDefault: true, aspectRatios: ["9:16", "1:1", "16:9", "4:5"],
    durationSec: { min: 0.5, max: 140 }, textLimit: 280, thumbnailTypes: ["provider_default"], titleField: false, firstCommentField: false, providerPolling: true, scheduling: true,
  },
} as const;
