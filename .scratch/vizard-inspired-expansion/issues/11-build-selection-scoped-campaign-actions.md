...
- [x] Route Render selected first, then export and ZIP, then style, Scene Template, and motion actions through ordered, fail-closed service admission.
- [x] Keep review and scheduling entries hidden until both their Campaign delivery stage and target service controls are enabled.
